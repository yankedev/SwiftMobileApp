...
class TalkTypeService : AbstractService {
    ...
    override func entryPoint() -> [String] {
        return ["http://cfp.devoxx.fr/api/conferences/DevoxxFR2016/proposalTypes"]
    }
        ...
        return Promise{ fulfill, reject in
            privateManagedObjectContext.performBlock {
                do {
                    ...
                    let predicateAttribute = NSPredicate(format: "label = %@", "talkType")
                    let fetchRequest = NSFetchRequest(entityName: "Attribute")
    ...
    override func unboxData(data : NSData) -> [NSManagedObject] {
        do {
            ...
            let arrayToParse = try json["proposalTypes"].rawData()
